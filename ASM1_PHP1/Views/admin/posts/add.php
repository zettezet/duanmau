...
<body>
  <div class="card">
    ...
    <form action="<?= BASE_URL . '?c=admin-product-store' ?>" method="post" enctype="multipart/form-data">
      <!-- Tiêu đề lớn -->
      <div class="mb-3">
        <label class="form-label">Tiêu đề chính (Big Title)</label>
        <input type="text" class="form-control" name="big_title" placeholder="Nhập tiêu đề chính..." required>
      </div>

      <!-- Tiêu đề nhỏ -->
      <div class="mb-3">
        <label class="form-label">Tiêu đề phụ (Small Title)</label>
        <input type="text" class="form-control" name="small_title" placeholder="Nhập tiêu đề phụ..." required>
      </div>
      ...
      <div class="d-flex justify-content-between mt-4">
        <a href="<?= BASE_URL . '?c=admin-product' ?>" class="btn btn-secondary">⬅ Quay lại</a>
