...
echo"so luong nhan vien la: $count";
$new=["ten"=>"Nguyen Gia An", "MaNV"=>"PH007", "luongcoban"=>6500000,"hesoluong"=>5];
array_push($nhanvien, $new);
array_pop($nhanvien);
$a=["Ha","Hoa","Hue"];
$b=["Lan","Linh","Ly"];
$arrMeeger=array_merge($a,$b);
echo"<pre>";
print_r($arrMeeger);
echo"</pre>";
$check=in_array("Lan",$a);
if($check==true){
    echo"Co";
}else{
    echo"Khong co";
}
$key=array_keys($nhanvien[0]);
echo"<pre>";
    print_r($key);
echo"</pre>";
?>
