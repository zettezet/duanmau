    ...
    <div class="container">
        ...
        <form action="<?= BASE_URL . '?c=admin-product-update&id=' . $product['id'] ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <textarea name="description" class="form-control" row=5 id=""><?= $product['description'] ?></textarea>
            </div>
            <div class="mb-3">
                <label for="" class="form-label">Content</label>
                <textarea name="content" class="form-control" row=10 id=""><?= $product['content'] ?></textarea>
            </div>
            <div class="mb-3">
